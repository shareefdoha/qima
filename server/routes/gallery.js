...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const [result] = await pool.execute(
      ...
      [String(title).trim(), type, type === 'photo' ? photoUrl : null, type === 'video' ? video_embed_url : null]
    );
...
router.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    const [result] = await pool.execute(
      ...
      [String(title).trim(), type, type === 'photo' ? photoUrl : null, type === 'video' ? video_embed_url : null, req.params.id]
    );
